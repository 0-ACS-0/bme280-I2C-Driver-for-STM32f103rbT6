...
struct bme280_meas_raw{
	uint32_t press_raw;			//Registro del valor de temperatura en crudo
	uint32_t temp_raw;			//Registro del valor de temperatura en crudo
	uint16_t hum_raw;			//Registro del valor de humedad en crudo
};
